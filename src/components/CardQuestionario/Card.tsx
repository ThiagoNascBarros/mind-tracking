...
export default function Card(props: CardProps) {
    ...
    return (
        <div className="w-full max-w-[480px] xs:max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto rounded-[12px] gap-2 xs:gap-4 sm:gap-6 md:gap-8 h-full border-3 border-[#3399FF] bg-[#161D2D] p-3 xs:p-4 sm:p-6 md:p-8 flex flex-col">
